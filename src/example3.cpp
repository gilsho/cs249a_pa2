...
int main(int argc, char *argv[]) {
    ...
    // -- Segments
    Ptr<Instance> s11 = manager->instanceNew("s11", "Plane segment");  
    ...
    s12->attributeIs("difficulty", "2");
    s21->attributeIs("difficulty", "1");
    s12->attributeIs("difficulty", "4");
    s31->attributeIs("difficulty", "3");
    s32->attributeIs("difficulty", "1");
    s41->attributeIs("difficulty", "2");
    s42->attributeIs("difficulty", "1");
    s51->attributeIs("difficulty", "2");
    s52->attributeIs("difficulty", "1");
    s61->attributeIs("difficulty", "5");
    s62->attributeIs("difficulty", "4");
    s71->attributeIs("difficulty", "1");
    s72->attributeIs("difficulty", "2");
    s81->attributeIs("difficulty", "1");
    s82->attributeIs("difficulty", "3");
    s91->attributeIs("difficulty", "2");
    s12->attributeIs("difficulty", "1");
    s101->attributeIs("difficulty", "4");
    s102->attributeIs("difficulty", "1");
    ...
    manager->instanceDel("tijuana");
    manager->instanceDel("s31");
    manager->instanceDel("s101");
    manager->instanceDel("s25348");
    ...
    cout << "**** explore la : cost 1200 time 30 ****" << endl;
